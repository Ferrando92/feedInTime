 ...
 */
class ElConfidencial extends \AppBundle\Entity\ElConfidencial implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ElConfidencial $proxy) {
    ...
    public function setActivaEnPortada($activaEnPortada)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setActivaEnPortada', array($activaEnPortada));

        return parent::setActivaEnPortada($activaEnPortada);
    }
    ...
    public function getActivaEnPortada()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getActivaEnPortada', array());

        return parent::getActivaEnPortada();
    }
